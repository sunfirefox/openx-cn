...
$GLOBALS['strClientHistory']                = "查看统计数据";
...
$GLOBALS['strConfirmDeleteClients']         = "您真的要删除选中的所有客户吗？";
$GLOBALS['strConfirmResetClientStats']      = "您真的要删除这个客户所有的统计数据吗？";
$GLOBALS['strSite']                         = "Site";
$GLOBALS['strHideInactive']                 = "隐藏没有统计数据的行";
$GLOBALS['strHideInactiveAdvertisers']      = "Hide inactive advertisers";
$GLOBALS['strInactiveAdvertisersHidden']    = "个没有统计数据的客户已被隐藏";
...
$GLOBALS['strCampaignHistory']              = "查看统计数据";
...
$GLOBALS['strHideInactiveCampaigns']        = "隐藏未开始的项目";
$GLOBALS['strInactiveCampaignsHidden']      = "个未开始的项目已被隐藏";
...
$GLOBALS['strActivationDate']            = "开始投放";
...
$GLOBALS['strConversionWindow']           = "数据转化有效时间";
...
$GLOBALS['strBannerHistory']                 = "查看统计数据";
...
$GLOBALS['strAffiliateHistory']            = "查看统计数据";
...
$GLOBALS['strAllowAffiliateZoneStats']      = "查看统计数据";
...
$GLOBALS['strPendingConversions_short']         = "待审数据";
