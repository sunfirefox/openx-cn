...
$GLOBALS['strHiddenAdvertiser'] = "客戶";
$GLOBALS['strClients'] = "客戶";
$GLOBALS['strClientsAndCampaigns'] = "客戶與項目";
$GLOBALS['strAddClient'] = "新增客戶";
$GLOBALS['strAddClient_Key'] = "新增客戶(<u>n</u>)";
$GLOBALS['strTotalClients'] = "所有客戶";
$GLOBALS['strClientProperties'] = "客戶屬性";
$GLOBALS['strClientHistory'] = "客戶歷史";
$GLOBALS['strNoClients'] = "目前沒有素材，請先<a href='advertiser-edit.php'>創建</a>";
$GLOBALS['strConfirmDeleteClient'] = "您真的希望刪除該客戶";
$GLOBALS['strHideInactiveAdvertisers'] = "隱藏停用的客戶";
$GLOBALS['strInactiveAdvertisersHidden'] = "不顯示停用的客戶";
...
$GLOBALS['strConfirmDeleteAllCampaigns'] = "您是否真的希望刪除該客戶下的所有素材";
...
$GLOBALS['strHiddenAd'] = "素材";
$GLOBALS['strHiddenTracker'] = "跟蹤系統";
$GLOBALS['strTracker'] = "跟蹤系統";
$GLOBALS['strAffiliate'] = "媒體";
$GLOBALS['strWebsite'] = "媒體";
...
$GLOBALS['strAddBanner'] = "新增一個素材";
$GLOBALS['strAddBanner_Key'] = "<u>新增</u>一個素材";
$GLOBALS['strModifyBanner'] = "修改素材";
$GLOBALS['strActiveBanners'] = "啟用中素材數";
$GLOBALS['strTotalBanners'] = "所有素材";
$GLOBALS['strShowBanner'] = "顯示素材";
$GLOBALS['strDeleteAllBanners'] = "刪除所有素材";
$GLOBALS['strActivateAllBanners'] = "激活所有素材";
$GLOBALS['strDeactivateAllBanners'] = "撤銷所有素材";
$GLOBALS['strBannerOverview'] = "素材預覽";
$GLOBALS['strBannerProperties'] = "素材屬性";
$GLOBALS['strBannerHistory'] = "素材歷史";
$GLOBALS['strConfirmDeleteBanner'] = "您是否真的希望刪除該素材";
$GLOBALS['strConfirmDeleteAllBanners'] = "你是否希望刪除該項目下的所有素材";
$GLOBALS['strShowParentCampaigns'] = "顯示父項目";
$GLOBALS['strHideParentCampaigns'] = "顯示父項目";
$GLOBALS['strHideInactiveBanners'] = "隱藏停用的素材";
$GLOBALS['strInactiveBannersHidden'] = "隱藏已停用的素材";
$GLOBALS['strAppendTextAdNotPossible'] = "文字鏈素材無法附帶其它素材";
...
$GLOBALS['strAdserverTypeGeneric'] = "生成HTML素材";
...
$GLOBALS['strAND'] = "與";
$GLOBALS['strOR'] = "或";
$GLOBALS['strOnlyDisplayWhen'] = "當： 時候顯示這條素材";
$GLOBALS['strWeekDay'] = "工作日";
$GLOBALS['strWeekDays'] = "工作日";
$GLOBALS['strTime'] = "時間";
$GLOBALS['strSource'] = "來源";
$GLOBALS['strCity'] = "城市";
$GLOBALS['strDeliveryLimitations'] = "投放限制";
...
$GLOBALS['strAffiliates'] = "媒體";
$GLOBALS['strAffiliatesAndZones'] = "媒體和版位";
$GLOBALS['strAddNewAffiliate'] = "新增一個媒體";
$GLOBALS['strAddNewAffiliate_Key'] = "新增<u>n</u>位媒體";
$GLOBALS['strAffiliateProperties'] = "媒體屬性";
$GLOBALS['strAffiliateHistory'] = "媒體歷史記錄";
$GLOBALS['strZonesWithoutAffiliate'] = "不屬於媒體的版位";
$GLOBALS['strMoveToNewAffiliate'] = "移至其他媒體";
$GLOBALS['strNoAffiliates'] = "目前沒有媒體，想要新建一個版位，請先<a href='affiliate-edit.php'>創建</a>一個媒體";
$GLOBALS['strConfirmDeleteAffiliate'] = "確定刪除此媒體？";
$GLOBALS['strMakePublisherPublic'] = "此媒體中版位公開可用";
$GLOBALS['strAffiliateInvocation'] = "調用代碼";
$GLOBALS['strTotalAffiliates'] = "所有媒體";
$GLOBALS['strInactiveAffiliatesHidden'] = "隱藏未激活的媒體";
$GLOBALS['strShowParentAffiliates'] = "顯示父媒體";
$GLOBALS['strHideParentAffiliates'] = "隱藏父媒體";
...
$GLOBALS['strBannerButtonRectangle'] = "旗標素材、按鈕素材或矩形素材";
$GLOBALS['strEmailAdZone'] = "電子郵件/郵件列表版位";
$GLOBALS['strZoneClick'] = "點擊跟蹤版位";
$GLOBALS['strShowMatchingBanners'] = "顯示符合條件的素材";
$GLOBALS['strHideMatchingBanners'] = "顯示符合條件的素材";
$GLOBALS['strTotalZones'] = "所有版位";
$GLOBALS['strCostInfo'] = "媒體成本";
$GLOBALS['strInactiveZonesHidden'] = "隱藏已停用的素材";
$GLOBALS['strWarnChangeZoneType'] = "因為素材形式的限制,將版位的形式更改成文字或電子郵件將會斷開與所有素材/項目的關聯。\n<ul>\n <li>文字版位只能與文字素材相關聯</li>\n<li>電子郵件素材版位項目一次僅能與一個激活素材關聯</li>\n</ul>";
$GLOBALS['strWarnChangeZoneSize'] = "由於素材尺寸沒有任何變化，所改變了版位的尺寸，斷開所有現有素材與該版位的關聯。需要重新關聯符合新尺寸的素材。";
...
$GLOBALS['strZonePrependHTML'] = "該版位允許為文字素材預先設定HTML代碼";
$GLOBALS['strZoneAppendHTML'] = "該版位允許為文字素材附加HTML代碼";
$GLOBALS['strZoneAppendNoBanner'] = "如果沒有素材投放則附加";
...
$GLOBALS['strPublisherDistribution'] = "媒體投放數";
$GLOBALS['strCampaignDistribution'] = "項目投放數";
$GLOBALS['strTargetStats'] = "目標統計";
$GLOBALS['strViewBreakdown'] = "瀏覽按照";
$GLOBALS['strItemsPerPage'] = "每頁顯示條數";
$GLOBALS['strDistributionHistory'] = "投放歷史";
...
$GLOBALS['strAllPublishers'] = "所有媒體";
$GLOBALS['strAnonPublishers'] = "匿名媒體";
...
$GLOBALS['strLogErrorBanners'] = "[phpAds] 當嘗試從數據庫中提取素材數據時出現了錯誤。";
...
$GLOBALS['strMailBannerStats'] = "{clientname}的素材統計數據:";
...
$GLOBALS['strMailNothingLeft'] = "如果您希望繼續在我們的媒體投放素材，請隨時與我們聯繫。";
...
$GLOBALS['strWarnClientTxt'] = "您素材的曝光量、點擊數或轉化數已經低於{limit}";
$GLOBALS['strImpressionsClicksConversionsLow'] = "曝光量/點擊數/轉換數已經過低";
$GLOBALS['strNoViewLoggedInInterval'] = "發送本報告時，系統並沒有關於素材曝光量的記錄。";
$GLOBALS['strNoClickLoggedInInterval'] = "發送本報告時，系統並沒有關於素材點擊數的記錄。";
$GLOBALS['strNoConversionLoggedInInterval'] = "發送本報告時，系統並沒有關於素材轉換數的記錄。";
...
$GLOBALS['strImpendingCampaignExpiryBody'] = "該項目即將自動失效，項目之下的素材也將一併失效:";
...
$GLOBALS['strDefaultBanners'] = "默認素材";
$GLOBALS['strDefaultBannerUrl'] = "默認圖片URL";
$GLOBALS['strDefaultBannerDestination'] = "默認關聯地址";
$GLOBALS['strAllowedBannerTypes'] = "允許的素材形式";
$GLOBALS['strTypeSqlAllow'] = "可使用本地數據庫素材";
$GLOBALS['strTypeWebAllow'] = "可使用Webserver伺服器本地素材";
$GLOBALS['strTypeUrlAllow'] = "使用外部素材";
$GLOBALS['strTypeHtmlAllow'] = "可使用HTML素材";
$GLOBALS['strTypeTxtAllow'] = "可使用文字素材";
$GLOBALS['strTypeHtmlSettings'] = "HTML素材選項";
$GLOBALS['strTypeHtmlAuto'] = "自動轉換HTML素材以實現點擊跟蹤";
$GLOBALS['strHome'] = "主頁";
...
$GLOBALS['strReasonBadCreative'] = "素材創意不恰當";
$GLOBALS['strReasonBadUrl'] = "目標URL不恰當";
$GLOBALS['strReasonBreakTerms'] = "媒體不符合前提和約定條件";
$GLOBALS['strTrackerPreferences'] = "跟蹤器首選項";
$GLOBALS['strBannerPreferences'] = "素材首選項";
$GLOBALS['strTypeHtmlPhp'] = "允許HTML格式素材中運行PHP表達式";
$GLOBALS['strAdvertiserSetup'] = "註冊客戶";
$GLOBALS['strAdvertiserSignup'] = "註冊客戶";
$GLOBALS['strSelectPublisher'] = "選擇媒體";
...
$GLOBALS['strAdveEmailWarnings'] = "客戶電子郵件告警";
...
$GLOBALS['strUserProperties'] = "素材屬性";
$GLOBALS['strBack'] = "回退";
...
$GLOBALS['strUserPreferences'] = "素材首選項";
$GLOBALS['strCampaigns'] = "項目";
$GLOBALS['strPercentBasketValue'] = "籃價值";
$GLOBALS['strAdvertiserSignupLink'] = "註冊客戶";
$GLOBALS['strAdvertiserSignupOption'] = "註冊客戶";
...
$GLOBALS['strNoClientsForBanners'] = "目前沒有素材，請先<a href='advertiser-edit.php'>創建</a>";
$GLOBALS['strAdvertiserCampaigns'] = "客戶與項目";
...
$GLOBALS['strZoneToWebsite'] = "沒有媒體";
$GLOBALS['strNoZonesAddWebsite'] = "目前沒有媒體，想要新建一個版位，請先<a href='affiliate-edit.php'>創建</a>一個媒體";
...
$GLOBALS['strChannelToWebsite'] = "沒有媒體";
$GLOBALS['strChannelsOfWebsite'] = "屬於";
$GLOBALS['strConfirmDeleteClients'] = "您真的希望刪除該客戶";
$GLOBALS['strConfirmDeleteCampaigns'] = "你是否希望刪除該項目";
$GLOBALS['strConfirmDeleteTrackers'] = "您是否希望刪除該跟蹤器 ";
$GLOBALS['strNoBannersAddCampaign'] = "目前沒有媒體，想要新建一個版位，請先<a href='affiliate-edit.php'>創建</a>一個媒體";
$GLOBALS['strNoBannersAddAdvertiser'] = "目前沒有媒體，想要新建一個版位，請先<a href='affiliate-edit.php'>創建</a>一個媒體";
$GLOBALS['strConfirmDeleteBanners'] = "您是否真的希望刪除該素材";
$GLOBALS['strConfirmDeleteAffiliates'] = "確定刪除此媒體？";
...
$GLOBALS['strNoChannelsAddWebsite'] = "目前沒有媒體，想要新建一個版位，請先<a href='affiliate-edit.php'>創建</a>一個媒體";
$GLOBALS['strConfirmDeleteChannels'] = "您是否真的希望刪除該目標頻道";
$GLOBALS['strSite'] = "大小";
$GLOBALS['strHiddenWebsite'] = "媒體";
$GLOBALS['strYouHaveNoCampaigns'] = "客戶與項目";
...
$GLOBALS['strCappingBanner']['limit'] = "限定素材瀏覽數為:";
...
$GLOBALS['strNoWebsites'] = "沒有媒體";
$GLOBALS['strSomeWebsites'] = "有些媒體";
...
$GLOBALS['strBannerSettings'] = "素材設置";
$GLOBALS['strDebugSettings'] = "調試日誌";
$GLOBALS['strCacheFiles'] = "文件";
$GLOBALS['strDeliveryBanner'] = "素材發送全局設置";
